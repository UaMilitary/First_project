...
def find_articles(key, letter_case=False):
    ...
    for dict in articles_dict:
        for keys_dict, value in dict.items():
            if letter_case == True and (key in str(value) or key in str(keys_dict)):
                ak = dict.keys()
                list_ak = list(ak)
                B = {}
                for k in list_ak:
                ...
                b.append(B)
                break
            elif letter_case == False and (key.lower() in str(value).lower() or key.lower() in str(keys_dict).lower()):
                ak = dict.keys()
                list_ak = list(ak)
                B = {}
                for k in list_ak:
